...
export default function PokeCard(props) {
    ...
    useEffect(() => {
        ...
        // 2. check if selected pokemon is in the cachce, otherwise fetch from the api
        ...
        <div className="poke-card">
            ...
            <div className="image-container">
                {imgList.map((spriteUrl, spriteIndex) => {
                    ...
                    return (
                        <img key={spriteIndex} src={imageUrl} alt={`${name}-img-${spriteUrl}`} />
                    )
                })}
            </div>
            <h3>Stats</h3>
            ...
            <div className="pokemon-move-grid">
                {moves.map((moveObj, moveIndex) => {
                    return (
                        <button className="pokemon-move" key={moveIndex}
                        onClick={() => {
